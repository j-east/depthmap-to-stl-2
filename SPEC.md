...
- **Plaque corner:** in organic mode the plaque's corner remains a SQUARE crop — a
  rectangle from the two adjacent board edges that GROWS toward the content until it
  swallows the nearest organic point (+6 mm), so the square boundary meets the organic
  curve at their intersection. No thin connector sticks; the plate is always one
  connected piece around the plaque.
